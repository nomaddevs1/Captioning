export const standardTutorials = {
  ...
  tutorials: [
    ...
    {
      position: {pos: "fixed", left: {md: "380"}, top: {base: "130px", md: "500"}},
      text: "Select lines within the text display to bold, italicize, or underline them."
    },
    {
      position: {pos: "fixed", left: {md: "380"}, top: {base: "130px", md: "600"}},
    ...
    {
      position: {pos: "fixed", left: {md: "770"}, top: {base: "130px", md: "60px"}},
